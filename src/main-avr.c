...
int main() {
    ...
    while(1) {
        ...
        sprintf(date_str, "%02u.%02u.%02u", date->tm_mday, date->tm_mon + 1, MAX(date->tm_year - 100, 0));
        ...
        // draw_icon((icon_t*)battery_icon, SCREEN_WIDTH - DOCK_WIDTH + 2, 18, (batt_icon_id == ICON_BATTERY_0 ? COLOR_RED : COLOR_BLACK));
